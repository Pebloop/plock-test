...
import 'package:poc/pages/create/editor/Components/BottomBarComponent.dart';
...
class Editor extends FlameGame {
  ...
  void onLoad() {
    ...
    final bottomBar = BottomBarComponent(size, objectContainer, selectObject, isObjectSelected, openEditor);
