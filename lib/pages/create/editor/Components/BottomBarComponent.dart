...
import 'package:poc/pages/create/editor/Components/BottomBarButtonComponent.dart';

import 'ObjectComponent.dart';
...
class BottomBarComponent extends PositionComponent {
  ...
  BottomBarComponent(this.screenSize, this.objectContainer, this.selectObject, this.isObjectSelected, this.openEditor);
  ...
  Future<void> onLoad() async {
    ...
    addBtn = BottomBarbuttonComponent('svg/add.svg', Vector2(0,0), tapAction: () {
      this.objectContainer.add(ObjectComponent(selectObject, isObjectSelected));
    });

    deleteBtn = BottomBarbuttonComponent('svg/delete.svg', Vector2(60,0), tapAction: () {
      this.objectContainer.remove(selectedObject());
    });

    editBtn = BottomBarbuttonComponent('svg/edit.svg', Vector2(120, 0), tapAction: () {
